...
--------------------------------------------------------------*/
	...
	jQuery(".storefront-popular-products .woocommerce .products").owlCarousel({
	...
	jQuery(".storefront-featured-products .woocommerce .products").owlCarousel({
		items: 3, //10 items above 1000px browser width
		itemsDesktop: [1024, 4], //4 items between 1024px and 901px
		itemsDesktopSmall: [900, 4], // 4 items betweem 900px and 601px
		itemsTablet: [768, 2], //2 items between 600 and 0;
	...
	jQuery(".storefront-best-selling-products .woocommerce .products").owlCarousel({
		items: 3, //10 items above 1000px browser width
		itemsDesktop: [1024, 4], //4 items between 1024px and 901px
		itemsDesktopSmall: [900, 4], // 4 items betweem 900px and 601px
		itemsTablet: [768, 2], //2 items between 600 and 0;
